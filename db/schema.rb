...
ActiveRecord::Schema.define(version: 2020_06_16_002015) do
...
# Could not dump table "Brasil" because of following StandardError
#   Unknown type 'geometry(MultiPolygonZM,4674)' for column 'geom'
...
# Could not dump table "lotes_201902" because of following StandardError
...
# Could not dump table "world_worldborder" because of following StandardError
#   Unknown type 'geometry(MultiPolygon,4326)' for column 'mpoly'
